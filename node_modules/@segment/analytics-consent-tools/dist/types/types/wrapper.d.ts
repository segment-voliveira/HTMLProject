...
export type SourceMiddlewareFunction = (middleware: SourceMiddlewareParams) => null | void | Promise<void | null>;
...
export type DestinationMiddlewareFunction = (middleware: DestinationMiddlewareParams) => null | void | Promise<void | null>;
/**
...
export interface AnyAnalytics {
    addDestinationMiddleware(integrationName: string, middleware: Function | DestinationMiddlewareFunction): any | this;
    addSourceMiddleware(middleware: Function | SourceMiddlewareFunction): any | this;
     ...
     */
    load(writeKeyOrSettings: AnalyticsBrowserSettings | string, options?: InitOptions): void;
}
/**
 ...
 **/
export type Wrapper<Analytics extends AnyAnalytics> = (analyticsInstance: Analytics) => Analytics;
/**
 * Create a function which wraps analytics instances to add consent management.
 */
export type CreateWrapper<Analytics extends AnyAnalytics> = (settings: CreateWrapperSettings) => Wrapper<Analytics>;
