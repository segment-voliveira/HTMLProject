...
import type { Categories, IntegrationCategoryMappings, CDNSettingsRemotePlugin } from './wrapper';
/**
 * See {@link CreateWrapperSettings.registerOnConsentChanged}
 */
export type RegisterOnConsentChangedFunction = (categoriesChangedCb: (categories: Categories) => void) => void;
/**
...
export interface CreateWrapperSettings {
     ...
     * ```
     */
    shouldEnableIntegration?: (integrationCategories: string[], categories: Categories, integrationInfo: Pick<CDNSettingsRemotePlugin, 'creationName'>) => boolean;
    /**
